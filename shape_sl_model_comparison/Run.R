...
prior.v<-list('intercept' = list(fn = 'gamma', par1 =100, par2 =50 ), 
              'base' = list(fn = 'gamma', par1 =2, par2=10),
              'rate' = list(fn = 'gamma', par1= 2,par2 =10),
              'proportion' = list(fn =  'gamma', par1 =1, par2 = 10),
              'jump' = list(fn = 'gamma', par1=.1, par2=7),
              'split' = list(fn = 'gamma', par1=10, par2=50),
              'sigma' = list(fn = 'gamma', par1=100, par2=100))

prior.params(prior.v$intercept)
